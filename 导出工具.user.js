...
(function () {
    ...
    bnt.onclick = function () {
        ...
        GM_xmlhttpRequest({
            ...
            url: "https://hikexam.hikvision.com/hikexam/exam-business/exam/getInfoByExamIdAnswerCheck",
            ...
            onload: function (response) {
                ...
                GM_xmlhttpRequest({
                    method: "POST",
                    headers: { "Accept": "application/json" },
                    url: "https://hikexam.hikvision.com/hikexam/exam-business/exam/getInfoByExamId",
